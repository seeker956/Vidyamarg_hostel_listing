...
<!-- Meta Tags for SEO -->
<meta name="description" content="Vidya Marg hostel listings offer comfortable accommodation with excellent facilities and amenities in a prime location. Browse through our listings and find the perfect hostel for your stay.">
<meta name="keywords" content="hostel listings, Vidya Marg hostel, hostel accommodation, student hostels, budget hostels, hostel near me, facilities, amenities, food and dining">
<meta name="author" content="Vidya Marg">
<meta name="robots" content="index, follow">

<!-- Open Graph Tags for Social Media Sharing -->
<meta property="og:title" content="Hostel Listings - Vidya Marg">
<meta property="og:description" content="Discover the best hostels listed on Vidya Marg with amazing amenities and affordable pricing. Your perfect hostel stay awaits!">
<meta property="og:image" content="images/hostel-image.jpg">
<meta property="og:url" content="https://www.vidyamarg.com/hostel/">
<meta property="og:type" content="website">

<!-- Twitter Card Tags -->
<meta name="twitter:title" content="Hostel Listings - Vidya Marg">
<meta name="twitter:description" content="Browse through a variety of hostels on Vidya Marg with excellent facilities, food options, and comfortable living spaces.">
<meta name="twitter:image" content="images/hostel-image.jpg">
...
<meta name="google-site-verification" content="A8DVxMqNjPbIMNthOZVmWByG8fBjbRCJTF3KmPGurJA" />

<!-- Title -->
<title>Hostel Listings - Vidya Marg | Comfortable & Affordable Hostels</title>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/02.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
    ...
    <div class="col">
        <div class="form-group">
            <label for="hostelType" class="text-white">Hostel Type</label>
            <select class="form-control" name="type" id="hostelType" aria-label="Select hostel type">
    ...
    <div class="col">
        <div class="form-group">
            <label for="hostelStatus" class="text-white">Status</label>
            <select class="form-control" name="stype" id="hostelStatus" aria-label="Select hostel status">
    ...
    <div class="col">
        <div class="form-group">
            <label for="cityInput" class="text-white">City</label>
            <input type="text" class="form-control" name="city" id="cityInput" 
                   placeholder="Enter City" required aria-label="Enter city name">
        </div>
    </div>
    ...
    <div class="col d-flex align-items-end">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Study Service</a></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Library Service</a></h5>
                                <p>This is a dummy text for filling out spaces. Just some random words...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Kitchen Room</a></h5>
                                <p>This is a dummy text for filling out spaces. Just some random words...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Best Hostel in Patna</h2>
                    </div>
                    - <div class="col-md-6">
                        <ul class="nav property-btn float-right" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item"> <a class="nav-link py-3" id="pills-contact-tab2" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Top Hostels</a> </li>
                            <li class="nav-item"> <a class="nav-link py-3" id="pills-contact-tab3" data-toggle="pill" href="#pills-resturant" role="tab" aria-controls="pills-contact" aria-selected="false">Best Hostels</a> </li>
                        </ul>
                    </div> -
                    <div class="col-md-12">
                                        ...
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="p-4 d-inline-block w-100">
                                                    <div class="float-left text-capitalize"><i class="fas fa-user text-success mr-1"></i>Owner: <?php echo $row['uname'];?></div>
                        ...
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Hostel Available</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
								<?php
										$query=mysqli_query($con,"SELECT count(pid) FROM property where stype='Boys'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Boys Hostel Available</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
								<?php
										$query=mysqli_query($con,"SELECT count(pid) FROM property where stype='Girls'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Girlss Hostel Available</div>
                            </div>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Popular Hostel in Patna</h2></div>
                </div>
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city=' '");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    ...
                                    <span><?php 
												$total = $row[0];
												echo $total;?> Hostels Listed</span> </div>
									<?php } ?>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='East Boring Canal Road'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
...
<!-- jQuery (Required for Bootstrap & Owl Carousel) -->
