<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+91 9110039890</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>info@vidyamarg.org</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
    ...
    <a class="navbar-brand position-relative" href="index.php">
        <img src="../../img/logo.png" alt="Vidyamarg" style="max-width: 100%; height: auto; width: 180px;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"> <a class="nav-link" href="property.php">Hostels</a> </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="submitproperty.php">Add Hostel</a> </li> 
        ...
        <a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php">Add Hostel</a> 
    </div>
</nav>
