  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/rsadmin.pg" alt="Vidyamarg">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/logo1.jpeg" alt="vidyamarg" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="userbuilder.php"> Owner </a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-location"></i> <span>Landmark & City</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="stateadd.php"> Landmark </a></li>
