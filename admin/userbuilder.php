...
<head>
        ...
        <title>Vidyamarg Homes | Admin</title>
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!--<a href="userbuilderedit.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">Edit</button></a>-->
                                                        <a href="userbuilderdelete.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">Delete</button></a>
                                                     </td>
                                                </tr>
                                                <?php
												$cnt=$cnt+1;
