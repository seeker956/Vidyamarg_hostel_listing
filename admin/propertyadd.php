						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Add Hostel Details</h4>
								</div>
								<form method="post" enctype="multipart/form-data">
								<div class="card-body">
									<h5 class="card-title">Hostel Detail</h5>
									<?php echo $error; ?>
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="title" required placeholder="Enter Hostel Name">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Descriptions</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Bed</label>
													<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30" readonly >
...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                <h5 class="card-title">General Amenities</h5>
                <label><strong>Washing Machine:</strong></label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2"><strong>Lift:</strong></label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2"><strong>Warden Contact:</strong></label>
                <input class="form-control" type="text" placeholder="Enter Warden Contact" />

                <label class="mt-2"><strong>CCTV Camera:</strong></label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                <h5 class="card-title">Connectivity & Power</h5>
                <label><strong>WiFi:</strong></label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2"><strong>Power Backup:</strong></label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2"><strong>Food:</strong></label>
                <select class="form-select">
                    <option>3 Times</option>
                    <option>4 Times</option>
                </select>

                <label class="mt-2"><strong>Cleaning:</strong></label>
                <select class="form-select">
                    <option>Daily</option>
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                ...
                <label class="mt-2"><strong>Guest Room for Parents:</strong></label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2"><strong>Attached Washroom:</strong></label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                ...
                <label class="mt-2">Building Age:</label>
                <input class="form-control" type="number" placeholder="Enter Age in Years" />

                <label class="mt-2">FSSAI License:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2">Fire Safety:</label>
                <select class="form-select">
                    <option>Available</option>
                    <option>Not Available</option>
                </select>
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                ...
                <label class="mt-2">Transport Facility:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2">Library:</label>
                <select class="form-select">
                    <option>Available</option>
                    <option>Not Available</option>
                </select>

                <label class="mt-2">Nearby Institute Distance:</label>
                <input class="form-control" type="text" placeholder="Enter Distance (e.g. 500m)" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                ...
                <label class="mt-2">Geyser:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2">AC Availability:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2">Cooler Available:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                <h5>Room & Washroom</h5>
                <label class="mt-2">Attached Washroom:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2">Wardrobe for Every Student:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>

                <label class="mt-2">Bed Type:</label>
                <select class="form-select">
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                <h5>Staff & Security</h5>
                <label class="mt-2">Staff Behavior:</label>
                <input class="form-control" type="text" placeholder="Enter Behavior (e.g. Friendly)" />

                <label class="mt-2">Warden Contact:</label>
                <input class="form-control" type="tel" placeholder="Enter Number" />

                <label class="mt-2">USP of Hostel:</label>
                <input class="form-control" type="text" placeholder="Enter Unique Selling Point" />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card p-3 mb-3 shadow-sm border-0">
                <h5>Study & Comfort</h5>
                <label class="mt-2">Study Table:</label>
                <select class="form-select">
                    <option>Available</option>
                    <option>Not Available</option>
                </select>

                <label class="mt-2">Chair for Every Student:</label>
                <select class="form-select">
                    <option>Yes</option>
                    <option>No</option>
                </select>
